...
Sample Size: 150 participants (100 treatment, 50 control) to provide 90% power to detect a 5-point difference in severity score.`,
  ...
  },
  {
    ...
    content: [
      ...
      'Inclusion criteria for the safety population included baseline biomarker assessment for cardiac function monitoring.',
      'Adverse Events (AEs):',
...
export const regulatoryFindings: RegulatoryFinding[] = [
  ...
  },
  {
    ...
    location: 'Safety Analysis, Inclusion criteria',
    textHighlight: 'baseline biomarker assessment for cardiac function monitoring',
  },
  {
    id: 'finding-5',
    sectionId: 'section-3',
    severity: 'blocker',
    description: 'Protocol deviations percentage requires detailed breakdown and impact assessment',
    location: 'Study Population & Demographics, paragraph 3',
    textHighlight: 'Protocol deviations were minimal (3.3%)',
  },
];
