import { ReportSection, DataAsset, ProtocolSection, UploadedFile, User, CompletenessElement, ReportCompletenessStatus } from '../types';
...
No unexpected serious adverse device effects were identified unless otherwise stated. All serious events were reviewed and assessed for regulatory significance.`,
  ...
  {
    id: 'section-9',
    title: 'Conclusions and Benefit-Risk Assessment',
    helperText: 'State the overall conclusions of the investigation, including an explicit benefit-risk assessment and regulatory conclusion.',
    content: `The clinical data generated in this investigation support the overall benefit-risk profile of the investigational device for its intended use. A full benefit-risk conclusion will be provided once study results are available.`,
    order: 9,
    ...
    completenessElements: [
      {
        ...
        isoReference: 'ISO 14155:2020 §7.3.14',
        status: 'not-yet-verified',
        aiSuggestion: 'missing',
      },
      {
        id: 'comp-9c-2',
        title: 'Statement on whether study met objectives',
        isoReference: 'ISO 14155:2020 §7.3.13',
        status: 'not-yet-verified',
        aiSuggestion: 'missing',
      },
      {
        id: 'comp-9c-3',
        title: 'Regulatory compliance conclusion',
        isoReference: 'EU MDR 2017/745 Article 62',
        status: 'not-yet-verified',
        aiSuggestion: 'missing',
      },
    ],
    guidance: {
      requiredElements: {
        reference: 'ISO 14155:2020 §7.3.13–7.3.14 · EU MDR Article 62',
        items: [
          'Clear statement on whether primary and secondary objectives were met',
          'Quantified benefit-risk conclusion with supporting data references',
          'Regulatory conclusion referencing applicable regulations and standards',
          'Recommendation for clinical use in the intended patient population',
          'Acknowledgement of study limitations',
        ],
        mustAlignWith: 'Must align with: Primary endpoint results (Section 7), Safety Analysis (Section 8), applicable regulations',
      },
      commonPitfalls: [
        'Benefit-risk conclusion is ambiguous or not quantified',
        'Regulatory conclusion omits specific regulation references',
        'Study limitations not acknowledged',
        'Conclusion inconsistent with results reported in other sections',
      ],
      referencedDocuments: [
        {
          name: 'Statistical Analysis Plan',
...
• Data Quality / Monitoring Summary`,
    ...
    appendices: [
      ...
      },
      {
        ...
        category: 'required',
        status: 'not-attached',
        description: 'All ICF versions used during the investigation, per ISO 14155:2020 §4.8.10',
      },
      {
        id: 'appendix-investigator-cvs',
        name: 'Investigator CVs and Qualification Documentation',
        category: 'required',
        status: 'not-attached',
        description: 'Current CVs and GCP training records for all principal and sub-investigators, per ISO 14155:2020 §6.4',
      },
      {
        id: 'appendix-ethics',
        ...
        category: 'required',
        status: 'not-attached',
        description: 'EC/IRB approval letters for all participating sites, per ISO 14155:2020 §8.2.7',
      },
      {
        id: 'appendix-dsmb',
