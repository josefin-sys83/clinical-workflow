          ...
          <div className="flex-1 overflow-y-auto p-4">
            ...
            <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded">
              <div className="flex items-center gap-2 mb-1">
                ...
                <div className="text-xs font-semibold text-blue-900">Audit logging:</div>
              </div>
                    ...
                    <div className="border-t border-slate-200 p-6 bg-white">
                      ...
                      {section.hasConflict && (
                        <div className="mb-4 flex items-center gap-2 text-xs">
                          ...
                          <span className="text-rose-700 font-medium">{section.conflictMessage}</span>
                        </div>
                      )}
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              {displayIssues.map((issue) => (
                <div key={issue.id} className="p-4 bg-rose-50 border border-rose-200 rounded-lg">
