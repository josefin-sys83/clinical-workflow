                ...
                <div className="flex justify-end pt-6 border-t border-slate-200">
                  <div className="flex gap-3">
                    ...
                    {section.status === 'Complete' && isAssignedApprover && (
                      <button className="px-5 py-2.5 text-sm bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        Approve Section
                      </button>
                    )}
                  </div>
