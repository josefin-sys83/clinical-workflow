...
export function ReviewModeConfirmation({ 
  isOpen, 
  onClose, 
  onConfirm, 
  blockerCount, 
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full mx-4">
        <div className="p-6">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg text-slate-900">
                {hasIssues ? 'Enter Review with Outstanding Issues?' : 'Enter Review Mode'}
              </h3>
            </div>
            <button 
              onClick={onClose}
          ...
          <div className="space-y-4 mb-6">
            {hasIssues ? (
              <>
                    ...
                    <div className="flex items-start gap-2 p-3 bg-red-50 border border-red-200 rounded">
                      <div>
                        <p className="text-xs font-medium text-red-900 mb-0.5">
                          {blockerCount} Critical Blocker{blockerCount > 1 ? 's' : ''}
                        </p>
                    ...
                    <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded">
                      <div>
                        <p className="text-xs font-medium text-amber-900 mb-0.5">
                          {warningCount} Open Warning{warningCount > 1 ? 's' : ''}
                        </p>
                    ...
                    <div className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-200 rounded">
                      <div>
                        ...
                        <p className="text-xs text-blue-800 leading-relaxed">
                          Sections {incompleteSections.join(', ')} are not fully complete.
                        </p>
                      </div>
                    </div>
                  )}
                ...
                <p className="text-xs text-slate-600 leading-relaxed italic">
                  Review Mode allows you to receive feedback and make updates. You can exit and re-enter 
                  review as many times as needed until all issues are resolved and the protocol is approved.
                </p>
              </>
            ) : (
              <>
                <p className="text-sm text-slate-700 leading-relaxed">
                  The protocol appears ready for review with no critical blockers or incomplete sections.
                </p>
            ...
            <div className="p-4 bg-slate-50 border border-slate-200 rounded">
              ...
              <ul className="text-xs text-slate-600 space-y-1 list-disc list-inside leading-relaxed">
                ...
                <li>AI focuses on consistency checking and risk highlighting</li>
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            <button 
              onClick={() => {
                window.open('https://www.figma.com/make/ybvApcbmI5uk1a8R4A7pLJ/Protocol-Review-Copy-?p=f&t=CDbZUujrUVjaWW8O-0', '_blank', 'noopener,noreferrer');
                onConfirm();
              }}
              className="px-4 py-2 bg-slate-700 text-white text-sm rounded hover:bg-slate-800 transition-colors flex items-center gap-2"
            >
