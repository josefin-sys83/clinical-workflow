                ...
                <div className="signature-block">
                  ...
                  <div className="signature-grid">
                    ...
                    <div className="signature-card">
                      <div className="signature-card-header">Coordinating Principal Investigator</div>
                      <div className="signature-card-name">Dr. Helena Schmit</div>
                      <div className="signature-card-org">University Heart Center Hamburg</div>
                      {signatures.investigator ? (
                        <div className="signature-display">
                          <img src={signatures.investigator.signature} alt="Signature" className="signature-image-small" />
                          <div className="signature-date-small">{signatures.investigator.date}</div>
                        </div>
                      ) : (
                        <button onClick={() => handleSign('investigator')} className="sign-button-new">
                          Click to Sign
                        </button>
                      )}
                    </div>
                    ...
                    <div className="signature-card">
                      <div className="signature-card-header">Sponsor Representative</div>
                      <div className="signature-card-name">Dr. Sarah Chen</div>
                      <div className="signature-card-org">Clinical Affairs Director</div>
                      {signatures.sponsor ? (
                        <div className="signature-display">
                          <img src={signatures.sponsor.signature} alt="Signature" className="signature-image-small" />
                          <div className="signature-date-small">{signatures.sponsor.date}</div>
                        </div>
                      ) : (
                        <button onClick={() => handleSign('sponsor')} className="sign-button-new">
                          Click to Sign
                        </button>
                      )}
                    </div>
                    ...
                    <div className="signature-status-cards">
                      <div className="signature-status-card">
                        <div className="signature-status-info">
                          ...
                          <div className="signature-status-name">Dr. Helena Schmit</div>
                        </div>
                      ...
                      <div className="signature-status-card">
                        <div className="signature-status-info">
                          ...
                          <div className="signature-status-name">Dr. Sarah Chen</div>
                        </div>
